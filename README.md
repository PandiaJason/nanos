...
*   **The nanos Route (Secure AND Fast)**: By running agent logic in a lightweight WASM sandbox and delegating LLM inference natively to the host's Metal/CUDA drivers, `nanos` combines lightweight sandbox isolation with native hardware speed and power efficiency.
